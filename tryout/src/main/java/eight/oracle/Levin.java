...
public class Levin {
   ...
   * https://en.wikipedia.org/wiki/Levenshtein_distance
   * <p>
   * which is derived from Hjelmqvist, Sten (26 Mar 2012), Fast, memory efficient Levenshtein
   * algorithm:
   * <p>
  ...
  /**
   * Main entry point that can be used to test and demonstrate the values created for the distance
