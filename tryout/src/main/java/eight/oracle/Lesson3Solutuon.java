...
//
//public class Lesson3Solutuon {
//
//  /* How many times to repeat the test.  5 seems to give reasonable results */
//  private static final int RUN_COUNT = 5;
//
//  /**
//   * Used by the measure method to determine how long a Supplier takes to return a result.
//   *
...
//
//  /**
//   * Repeatedly generate results using a Supplier to eliminate some of the issues of running a
//   * micro-benchmark.
//   *
...
//
//  /**
//   * Computes the Levenshtein distance between every pair of words in the subset, and returns a
//   * matrix of distances. This actually computes twice as much as it needs to, since for every word
//   * a, b it should be the case that lev(a,b) == lev(b,a) i.e., Levenshtein distance is
//   * commutative.
//   *
...
//        distances[i][j] = Levin.lev(wordList.get(i), wordList.get(j));
//      }
//    });
//
//    return distances;
